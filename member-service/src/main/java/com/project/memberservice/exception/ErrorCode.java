...
public enum ErrorCode {
    ...
    INVALID_REQUEST_CONTENT(HttpStatus.BAD_REQUEST, "USER-002", "유효성 검사 오류가 발생했습니다."),
    DUPLICATE_DATA(HttpStatus.CONFLICT, "USER-003", "중복된 데이터가 존재합니다."),
    PHONE_ALREADY_EXISTS(HttpStatus.CONFLICT, "USER-004", "이미 사용 중인 전화번호입니다."),
    EMAIL_ALREADY_EXISTS(HttpStatus.CONFLICT, "USER-005", "이미 사용 중인 이메일입니다."),
