...
public enum ErrorCode {
    ...
    ORDER_LOCK_FAILED(HttpStatus.CONFLICT, "O_LOCK-001", "LOCK을 획득하지 못했습니다."),
    ORDER_LOCK_INTERRUPTED(HttpStatus.INTERNAL_SERVER_ERROR, "O_LOCK-002", "LOCK 처리 중에 인터럽트가 발생했습니다.");
